...
namespace CodingConnected.TLCProF.Models
{
    ...
    public class ControllerModel : ITLCProFModelBase
    {
        ...
        private List<DetectorModel> _allDetectors;
        ...
        [IgnoreDataMember]
        public List<DetectorModel> AllDetectors
        {
            get
            {
                return _allDetectors ??= SignalGroups.SelectMany(sg => sg.Detectors).ToList();
            }
        }
        ...
        public void OnMaximumWaitingTimeExceeded(object sender, EventArgs e)
        {
        ...
        public void OnSignalGroupStateChanged(object sender, EventArgs e)
        {
