...
public class SignalGroupModel : ITLCProFModelBase
{
    ...
    public SignalGroupStateEnum State
    {
        get
        {
            ...
            {
                InternalSignalGroupStateEnum.FixedGreen or InternalSignalGroupStateEnum.WaitGreen or InternalSignalGroupStateEnum.ExtendGreen or InternalSignalGroupStateEnum.FreeExtendGreen => SignalGroupStateEnum.Green,
                InternalSignalGroupStateEnum.Amber => SignalGroupStateEnum.Amber,
                InternalSignalGroupStateEnum.FixedRed or InternalSignalGroupStateEnum.Red or InternalSignalGroupStateEnum.NilRed => SignalGroupStateEnum.Red,
    ...
    [IgnoreDataMember]
    public List<SignalGroupStateRequestModel> CurrentStateRequests
    {
        get
        {
    ...
    [DataMember]
    public SignalGroupType Type { get; set; }
